...
const Footer = () => {
  return (
    <div className="w-full flex justify-center items-center flex-col">
      <div className="w-[94%] flex-col flex   md:flex-row  md:justify-between">
        <div className="pl-[1.2rem] text-start">
          <h2 className="text-[#172E80]">Fintekk</h2>
          <p className="text-[10px] md:w-[233px]">
            Fintekk is the bank that does it all. Manage everything directly and
            easy with fintekk.
          </p>
        </div>
        <div className="text-[#172E80] flex flex-wrap justify-between  p-5   footer md:justify-between md:w-[73%]">
